/* mp4-muxer v5.2.1 - MIT licence - https://github.com/Vanilagy/mp4-muxer
 * Vendored from build/mp4-muxer.js with this banner added (the code below is
 * unchanged). It exists so the page can write an MP4 in the browser with no
 * build step and no server: Firefox can ENCODE H.264 through WebCodecs but has
 * no MP4 recorder, so the container has to be muxed here. Loaded as a classic
 * script; exposes window.Mp4Muxer = { Muxer, ArrayBufferTarget, ... }.
 * Licence text: static/vendor/mp4-muxer.LICENSE
 */
"use strict";
var Mp4Muxer = (() => {
